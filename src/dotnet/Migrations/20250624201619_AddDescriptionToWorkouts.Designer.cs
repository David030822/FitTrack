...
namespace dotnet.Migrations
{
    ...
    [Migration("20250624201619_AddDescriptionToWorkouts")]
    partial class AddDescriptionToWorkouts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet.DAL.MealAdviceDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("dotnet.DAL.PlannedWorkoutDAL", b =>
                {
                    b.Property<int>("PlannedWorkoutID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PlannedWorkoutID"));
                    ...
                    b.Property<int>("WorkoutScheduleDayID")
                        .HasColumnType("integer");

                    b.HasKey("PlannedWorkoutID");

                    b.HasIndex("WorkoutScheduleDayID");
            ...
            modelBuilder.Entity("dotnet.DAL.WorkoutPlanDAL", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("dotnet.DAL.WorkoutScheduleDAL", b =>
                {
            ...
            modelBuilder.Entity("dotnet.DAL.WorkoutScheduleDayDAL", b =>
                {
                    b.Property<int>("WorkoutScheduleDayID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("WorkoutScheduleDayID"));
                    ...
                    b.Property<string>("WorkoutLabel")
                        .HasColumnType("text");

                    b.Property<int>("WorkoutScheduleID")
                        .HasColumnType("integer");

                    b.HasKey("WorkoutScheduleDayID");
            ...
            modelBuilder.Entity("dotnet.DAL.PlannedWorkoutDAL", b =>
                {
                    b.HasOne("dotnet.DAL.WorkoutScheduleDayDAL", "WorkoutScheduleDay")
                        .WithMany("PlannedWorkouts")
                        .HasForeignKey("WorkoutScheduleDayID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WorkoutScheduleDay");
                });
            ...
            modelBuilder.Entity("dotnet.DAL.WorkoutScheduleDayDAL", b =>
                {
                    b.HasOne("dotnet.DAL.WorkoutScheduleDAL", "WorkoutSchedule")
                        .WithMany("Days")
